...
A=sparse([],[],[],n+1,n+1,3*n); % allocation of sparse matrix A
...
% assembling right hand side matrix b
b = sparse(n+1,1) ;
...
xlabel( ' x (m) ' )
ylabel( ' theta ' )
legend ([plot1 plot2],{'numerical (n=640)','Analitical solution'}) % validation
